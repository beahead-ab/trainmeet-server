...
class LocalServerStartupTests(unittest.TestCase):
    ...
    def test_remote_reset_preserves_admin_session_and_server_name(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            connection.execute("INSERT INTO runtime_settings VALUES ('discovery_server_id', 'installation-id')")
            ...
            self.assertEqual(("installation-id",), connection.execute("SELECT value FROM runtime_settings WHERE key='discovery_server_id'").fetchone())
