    ...
    await page.route('**/*', async route => {
      ...
      if (url.pathname.startsWith('/v1/')) {
        ...
        switch (url.pathname) {
          ...
          case '/v1/display': data = { clock: clock(), meet: { id: 'meet-1', name: 'Demo meet' }, active_day: 'Dagl', publication_id: 'pub-1', stations: [], connections: [], routes: [], train_positions: [], connection_states: [], connection: { screens: [] } }; break;
